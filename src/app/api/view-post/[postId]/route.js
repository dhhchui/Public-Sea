...
export async function GET(request, { params }) {
  console.log("Received GET request to /api/boards/[board]/[postId]", { params });
  ...
  try {
    ...
    if (post.board.slug !== board) {
      console.log("貼文不屬於此討論區:", { postIdInt, board, postBoard: post.board.slug });
    ...
    console.error("錯誤處理 GET /api/boards/[board]/[postId]:", error);
    return new Response(
